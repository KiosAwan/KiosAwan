...
const Feature = ({ User, navigation, _featureDisabled }) => {
	...
	return (
		<View>
			<Text font="SemiBold" style={{ paddingBottom: SizeList.base }}>
				Menu Utama
			</Text>
			<TouchableOpacity onPress={_onPressCashier}>
				<Wrapper spaceBetween shadow style={styles.cardWrapper}>
					<Image
						...
						_width="20%"
						source={require("src/assets/icons/home/kasir.png")}
					/>
					<View _width="80%">
						...
						<Text>
							Masuk kedalam mode kasir dan atur penjualan kios atau warung
						</Text>
					</View>
				</Wrapper>
			</TouchableOpacity>
			<TouchableOpacity onPress={_onPressPayment}>
				<Wrapper spaceBetween shadow style={styles.cardWrapper}>
					<Image
						...
						style={{ resizeMode: "contain" }}
						_width="20%"
						source={require("src/assets/icons//home/ppob.png")}
					/>
					<View _width="80%">
						<Text font="SemiBold" color="primary">
							PEMBAYARAN (PPOB)
						...
						<Text>
							Lakukan pembayaran tagihan listrik, PDAM, pulsa, paket data, dll
						</Text>
					</View>
				</Wrapper>
			</TouchableOpacity>
			<TouchableOpacity onPress={_onPressStock}>
				<Wrapper spaceBetween shadow style={styles.cardWrapper}>
					<Image
						...
						style={{ resizeMode: "contain" }}
						_width="20%"
						source={require("src/assets/icons/home/restock.png")}
					/>
					<View _width="80%">
						<Text font="SemiBold" color="primary">
							BELANJA STOK
						...
						<Text>
							Dapatkan berbagai macam produk untuk kebutuhan kios atau warung
						</Text>
					</View>
				</Wrapper>
			</TouchableOpacity>
			<TouchableOpacity onPress={_onPressHutang}>
				<Wrapper
					spaceBetween
					shadow
					style={[styles.cardWrapper, { marginBottom: 0 }]}>
					<Image
						size={50}
						style={{ resizeMode: "contain" }}
						_width="20%"
						source={require("src/assets/icons/home/hutang.png")}
					/>
					<View _width="80%">
						<Text font="SemiBold" color="primary">
							PENCATATAN HUTANG
