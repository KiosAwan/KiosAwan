				...
				<Body style={{ marginBottom: 120, padding: 0 }}>
					<View
						...
						<Wrapper justify="space-between" style={{ padding: 10 }}>
							...
							<Text font="Regular">
								{tagihanData.transaction.peserta} orang
							</Text>
						</Wrapper>
						<Divider />
						<Wrapper justify="space-between" style={{ padding: 10 }}>
							...
							<Text font="Regular">
								{tagihanData.transaction.periode} bulan
							</Text>
						</Wrapper>
						<Divider />
						<Wrapper justify="space-between" style={{ padding: 10 }}>
							...
							<Text font="Regular">
								{convertRupiah(tagihanData.transaction.adminBank)}
							</Text>
						</Wrapper>
						<Divider />
						<Wrapper justify="space-between" style={{ padding: 10 }}>
						...
						<TouchableOpacity
							...
							<Text color="primary" font="Regular">
								DETAIL
							</Text>
						</TouchableOpacity>
						{detail
							? tagihanData.details.rMap((item, i) => (
									<View key={i}>
										<Wrapper
