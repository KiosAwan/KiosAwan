	...
	return (
		<Container
			...
			<AwanPopup.Title
				...
				visible={alertDel}
				message={`Kategori ${form.name_product_category} akan dihapus dari daftar kategorimu.`}>
				<View></View>
				<Button
				...
				<Button onPress={_handleDeleteCategory} style={{ width: "25%" }}>
					Ya
				</Button>
			</AwanPopup.Title>
			<Modal
			...
			<Body>
				<Input
					label="Nama Kategori"
					value={form.name_product_category}
					onChangeText={name_product_category =>
						setForm({ name_product_category })
					}
				/>
				<Text style={{ marginTop: SizeList.base }} align="center">
