...
const Container = props => {
	...
	return (
		<View
			...
			<BarStatus />
			{props.header && (
				<GlobalHeaderWithIcon onlyTitle={onlyTitle} {...props.header} />
			)}
			{props.children}
		</View>
	)
...
const Body = props => {
	...
	return (
		<ScrollView {...props} showsVerticalScrollIndicator={false}>
			<View style={{ padding: SizeList.bodyPadding, ...style }}>
				{props.children}
			</View>
		</ScrollView>
	)
...
const BodyFlatList = props => (
	<FlatList
		{...props}
		style={{ margin: SizeList.bodyPadding, ...props.style }}
	/>
)
		...
		<View
			...
			style={{
				...(!noPadding && {
					...
					marginBottom: SizeList.bodyPadding,
				}),
				...style,
			}}
		/>
