			...
			<View style={{ flex: 1, backgroundColor: ColorsList.authBackground }}>
				...
				{!this.state.loading ? (
					<ScrollView style={{ paddingHorizontal: SizeList.bodyPadding }}>
								...
								<Wrapper
									...
									<View style={{ alignItems: "center", flexDirection: "row" }}>
										...
										<View
											...
											<Text font="SemiBold">
												{this.state.printEnable.name || "UNKNOWN"}
											</Text>
						...
						{this.props.Printer.data.length > 0 &&
							this.props.Printer.data[0].boundAddress !=
								(this.state.printEnable
									...
									{this.props.Printer.data.rMap((a, i) =>
										...
										(this.state.printEnable
											...
											<Fragment>
												<TouchableOpacity
													onPress={
														this.state.bleOpend
															...
															: () =>
																	alert(
																		"Mohon hidupkan bluetooth terlebih dahulu",
																	)
													}>
												...
												{i != this.props.Printer.data.length - 1 && (
