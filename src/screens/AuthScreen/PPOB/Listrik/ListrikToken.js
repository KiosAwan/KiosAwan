						...
						{response.length == 0 ? (
							...
							<View>
								...
								<Wrapper justify="space-between">
									...
									<Text font="Regular">
										{parseInt(response.transaction.daya)} VA
									</Text>
								</Wrapper>
							</View>
						)}
									...
									<Wrapper
										...
										<View _width="60%">
											<Text font="SemiBold" style={{ marginLeft: 5 }}>
												{`TOKEN ${item.product_name.split(" ")[2]}`}{" "}
											</Text>
										</View>
										<View _width="40%">
											<Text size={8}>HARGA</Text>
											<Text font="SemiBold" color="primary">
												{convertRupiah(item.total)}
											</Text>
										</View>
									</Wrapper>
								</TouchableOpacity>
