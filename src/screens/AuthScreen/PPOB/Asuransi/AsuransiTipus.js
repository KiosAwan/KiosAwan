...
const AsuransiTipus = ({ navigation }) => {
	...
	return <Container header={{
		...
		<ContainerBody style={{ padding: 10, borderRadius: 5 }}>
			...
			{detailOn && <View style={{ marginTop: 15 }}>
				<Text>Sunt veniam et tempor sunt sit ullamco id eiusmod ea culpa. Et veniam consequat nostrud velit mollit exercitation aute consectetur aute veniam veniam tempor et sit.</Text>
				<Text>Sunt veniam et tempor sunt sit ullamco id eiusmod ea culpa. Et veniam consequat nostrud velit mollit exercitation aute consectetur aute veniam veniam tempor et sit.</Text>
			</View>}
			<View style={{
				marginTop: 15,
