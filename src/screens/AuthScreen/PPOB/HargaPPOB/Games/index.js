...
const AturGames = ({ navigation }) => {
    return <Container>
        <GlobalHeader title="Atur Harga Pembayaran Games" onPressBack={() => navigation.goBack()} />
        <ContainerBody>
            {[1, 2].map((item, i) => (<Wrapper key={i} style={styles.wrapper} justify="space-between">
                <Wrapper _width="60%" style={styles.leftWrapper}>
                    ...
                    <Text _width="60%">Games - Garena Game Online</Text>
                </Wrapper>
