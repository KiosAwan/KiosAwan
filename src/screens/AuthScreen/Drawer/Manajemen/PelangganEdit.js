	...
	return (
		<Container>
			...
			<AwanPopup.Title
				...
				visible={alertDel}
				message={`${form.name_customer} akan dihapus dari daftar pelanggan.`}>
				<View></View>
				<Button
					onPress={() => setAlertDel(false)}
					style={{ width: "25%" }}
					color="link">
					Batal
				</Button>
				<Button onPress={_handleDeleteCustomer} style={{ width: "25%" }}>
					Ya
				</Button>
			</AwanPopup.Title>
			<GlobalHeader
				...
				renderRightAccessory={() => (
					<TouchableOpacity onPress={() => setAlertDel(true)}>
			...
			<Body>
				...
				<View style={{ marginTop: 10 }}>
					<Input
						label="No Telepon"
						value={form.phone_number_customer}
						keyboardType="number-pad"
						onChangeText={phone_number_customer =>
							setForm({ phone_number_customer })
						}
					/>
				</View>
				<Text align="center" style={{ marginTop: SizeList.base }}>
					Ubah data pelanggan
				</Text>
			</Body>
			<Footer>
				<Button width="100%" onPress={_handleFinishEdit}>
					SIMPAN
				</Button>
			</Footer>
		</Container>
