	...
	return (
		<View style={styles.mainView}>
			...
			<AwanPopup.Title
				...
				<Button onPress={__handleDeleteProduct} style={{ width: "25%" }}>
					Ya
				</Button>
			</AwanPopup.Title>
			...
			<ModalCustom
				...
				<View style={{ padding: 15 }}>
					<Text style={{ color: ColorsList.primaryColor }}>
					...
					<View
						style={{
							width: "100%",
							height: 1,
							backgroundColor: ColorsList.greySoft,
							marginTop: 5,
						}}
					/>
					...
					<View style={styles.viewButtonPopup}>
						<Button
							...
							onPress={_handleSaveNewCategory}>
				...
				<View styles={{ paddingHorizontal: 20 }}>
					...
					<View style={{ marginTop: SizeList.base }}>
						<Input
							...
							onChangeText={text =>
								text.length <= 45 ? dispatch(editProductName(text)) : null
							}
						/>
					</View>
					<SelectBoxModal
						...
						value={Category.data
							.rMap(cat => {
								if (cat.id_product_category == EditProduct.id_category)
									return cat.name_product_category
							})
							.join("")}
