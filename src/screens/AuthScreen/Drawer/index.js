				...
				onPress={() => {
					if (props.name == "Keluar") {
						...
						navigation.navigate("/news-screen", {
							title: "Tutorial",
							link: "https://kiosawan.com/tutorial/",
							tutorial: true,
						})
					} else {
		...
		<Container>
			...
			<Body>
				<Wrapper style={{ marginBottom: 10 }} justify="space-between">
					<View>
						<Text font="SemiBold">
							{User && User.data.name && User.data.name.toUpperCase()}
						</Text>
						<Text size={12}>{User.data.reff_code}</Text>
					</View>
					<Button disabled style={{ width: 110 }} padding={5}>
						FREE USER
					</Button>
				</Wrapper>
				...
				<View style={[stylesglobe.shadowView, styles.viewSeparator]}>
					<AkunButton name="Ubah email" route="/drawer/settings/change-email" />
					<Divider />
					<AkunButton
						name="Ubah No. Hp"
					...
					/>
					<Divider />
					<AkunButton name="Ubah PIN" route="/drawer/settings/change-pin" />
					<Divider />
					<AkunButton
						name="Lupa PIN"
				...
				<View style={[stylesglobe.shadowView, styles.viewSeparator]}>
					...
					/>
					<Divider />
					<AkunButton name="Helpdesk" route="/drawer/help" />
					<Divider />
					<AkunButton name="Rate Awan" route="" noBottom />
				</View>
				<View style={[stylesglobe.shadowView, styles.viewSeparator]}>
					<AkunButton name="Keluar" route="" />
				</View>
