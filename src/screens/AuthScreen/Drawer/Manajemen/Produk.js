		...
		<View style={{ backgroundColor: ColorsList.authBackground, flex: 1 }}>
			...
			<View style={{ paddingHorizontal: 20, flex: 1 }}>
				<ScrollView
					...
					style={{ marginTop: 15, flex: 1, marginBottom: 40 }}>
					{Product.isLoading ? (
						<View>
							<ProductPlaceholder />
							<ProductPlaceholder />
							...
							.rMap((data, i) => {
								return (
									<ProductCard
										key={i}
										productImage={
											data.photo_product !== "" ? `${data.photo_product}` : null
										}
										...
										right={
											<TouchableOpacity
												onPress={() => {
													...
													dispatch(
														editProductIdCategory(data.id_product_category),
													)
